 ...
 *
 * by Josh de Leeuw - with minor style edits by Agnes Norbury 01/02/19 [for use with online-game study]
 *
...
jsPsych.plugins['image-slider-response2'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var html = '<div id="jspsych-image-slider-response-wrapper" style="margin: 30px 0px;">';
    ...
    for(var j=0; j < trial.labels.length; j++){
      ...
      html += '<div style="display: inline-block; position: absolute; left:'+left_offset+'%; text-align: center; margin: 0px 0px; width: '+width+'%;">';
    ...
    // add submit button
    html += '<button id="jspsych-image-slider-response-next" style="padding: 5px 5px; font-size: 24px;" class="jspsych-btn">'+trial.button_label+'</button>';
